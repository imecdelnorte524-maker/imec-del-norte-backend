...
export class CreateAtsWithSignatureDto {
  ...
  @ApiProperty({ description: 'Nombre del firmante', example: 'Juan Pérez García' })
  @IsString()
  userName: string;
  ...
  @ApiProperty({ description: 'Nombre del cliente', required: false, example: 'Empresa ABC S.A.' })
  @IsString()
  @IsOptional()
  clientName?: string;

  @ApiProperty({ description: 'NIT del cliente', required: false, example: '900123456-7' })
  @IsString()
  @IsOptional()
  clientNit?: string;
